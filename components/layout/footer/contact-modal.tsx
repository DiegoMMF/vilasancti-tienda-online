...
export default function ContactModal() {
  ...
  const handleLinkedIn = () => {
    window.open("https://www.linkedin.com/in/diegommf", "_blank");
    closeModal();
  };

  const handleWhatsApp = () => {
    const message = encodeURIComponent("Hola Diego, me interesa contactarte para un presupuesto de proyecto web o de inteligencia artificial.");
    window.open(`https://wa.me/5493544659093?text=${message}`, "_blank");
    closeModal();
  };
  ...
  return (
    <>
      <button
        onClick={openModal}
        className="font-cormorant text-[#bf9d6d] hover:text-[#f0e3d7] hover:bg-[#bf9d6d] hover:no-underline px-2 py-1 rounded-md transition-all duration-200 cursor-pointer"
      >
                  ...
                  <div className="space-y-6">
                       ...
                       <div className="relative py-1">
                         <p className="text-base text-[#bf9d6d]/90 font-inter leading-relaxed">
                           Téc.Univ. <strong className="text-[#bf9d6d] font-semibold">Diego M. Maldini Freyre</strong>
                         </p>
                       </div>
